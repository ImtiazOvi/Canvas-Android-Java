...
public class RadarView extends View {
    ...
    int shaderColor1 = Color.parseColor("#00FFFFFF");
    int shaderColor2 = Color.parseColor("#00FFFFFF");
    ...
    public RadarView(Context context, @Nullable AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RadarViewTest);
        shaderColor1 = ta.getColor(R.styleable.RadarViewTest_startColor, shaderColor1);
        shaderColor1 = ta.getColor(R.styleable.RadarViewTest_endColor, shaderColor1);

        mRadarBgColor = ta.getColor(R.styleable.RadarViewTest_bgColor, mRadarBgColor);
        mRadarLineColor = ta.getColor(R.styleable.RadarViewTest_lineColor, mRadarLineColor);
        radarCircleCount = ta.getColor(R.styleable.RadarViewTest_circleCount, radarCircleCount);
    ...
    private void init() {
        ...
        mRadarRadius = 300;
        radarShader = new SweepGradient(0, 0, shaderColor1, shaderColor2);
        matrix = new Matrix();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i <= 5; i++) {
            canvas.drawCircle(0, 0, (float) (i * 1.0 / 5 * mRadarRadius), mRadarPaint);
        }
